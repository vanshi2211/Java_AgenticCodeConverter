...
st.set_page_config(page_title="Agentic Java Refactor with CrewAI", layout="centered")
...
uploaded_file = st.file_uploader("📂 Upload your legacy Java code", type="java")
...
if uploaded_file:
    ...
    st.success("✅ Legacy Java code uploaded successfully.")
    # st.text(file_content)  
    # print("File uploaded at", datetime.datetime.now())
    st.code(file_content, language="java")

    if st.button("🚀 Start Refactoring Process", type="primary"):
        # print("reached A") 
